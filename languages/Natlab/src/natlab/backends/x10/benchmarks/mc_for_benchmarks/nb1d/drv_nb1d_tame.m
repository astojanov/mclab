...
function  [x] = drv_nb1d(scale)
  ...
  [dT] = mtimes(mc_t24, mc_t25);      % dT=(double,0.04165,[1, 1],{REAL})
  mc_t26 = .5;                        % mc_t26=(double,0.5,[1, 1],{REAL})
  mc_t27 = 32.4362;                   % mc_t27=(double,32.4362,[1, 1],{REAL})
  [mc_t2] = mtimes(mc_t26, mc_t27);   % mc_t2=(double,16.2181,[1, 1],{REAL})
  ...
  [mc_t9] = uminus(mc_t37);           % mc_t9=(double,-0.4,[1, 1],{REAL})
  mc_t38 = 1;                         % mc_t38=(double,1.0,[1, 1],{REAL})
  [mc_t7] = rand(mc_t8, mc_t38, mc_t9); % mc_t7=(double,[?, 1, 0],{REAL})
...
% results: [(double,1.0,[1, 1],{REAL})]% args: {n=(double,[1, 1],{REAL}), Rx=(double,[?, 1],{REAL}), Ry=(double,[?, 1],{REAL}), 
%       Rz=(double,[?, 1],{REAL}), m=(double,[?, 1],{REAL}), dT=(double,0.04165,[1, 1],{REAL}), 
%       T=(double,[1, 1],{REAL})}
function  [Fx, Fy, Fz, Vx, Vy, Vz] = nbody1d(n, Rx, Ry, Rz, m, dT, T)
  ...
  for t = (mc_t85 : dT : T);
    ...
    for k = (mc_t84 : n);
      ...
      [drx] = minus(mc_t44, mc_t45);      % drx=(double,[?, 1],{ANY})
      mc_t46 = Ry;                        % mc_t46=(double,[?, 1],{ANY})
      [mc_t47] = Ry(k);                   % mc_t47=(double,[1, 1],{ANY})
      [dry] = minus(mc_t46, mc_t47);      % dry=(double,[?, 1],{ANY})
      mc_t48 = Rz;                        % mc_t48=(double,[?, 1],{ANY})
      [mc_t49] = Rz(k);                   % mc_t49=(double,[1, 1],{ANY})
      [drz] = minus(mc_t48, mc_t49);      % drz=(double,[?, 1],{ANY})
      [mc_t52] = times(drx, drx);         % mc_t52=(double,[?, 1],{ANY})
      [mc_t53] = times(dry, dry);         % mc_t53=(double,[?, 1],{ANY})
      [mc_t50] = plus(mc_t52, mc_t53);    % mc_t50=(double,[?, 1],{ANY})
      [mc_t51] = times(drz, drz);         % mc_t51=(double,[?, 1],{ANY})
      [r] = plus(mc_t50, mc_t51);         % r=(double,[?, 1],{ANY})
      mc_t82 = 1.0;                       % mc_t82=(double,1.0,[1, 1],{REAL})
      r(k) = mc_t82;                      % r=(double,[?, 1],{ANY})
      ...
      [mc_t57] = rdivide(M, r);           % mc_t57=(double,[?, 1],{ANY})
